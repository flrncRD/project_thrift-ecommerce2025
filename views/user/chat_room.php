...
if (!$partner) die("User tidak ditemukan.");
?>

<div class="flex flex-col w-full h-[calc(100vh-5rem)] bg-gray-100">

    <div class="bg-white px-6 py-3 border-b border-gray-200 flex items-center justify-between shadow-sm sticky top-0 z-10">
        <div class="flex items-center gap-4">
            <a href="chat_list.php" class="text-gray-500 hover:text-[#1E3A8A] p-1 rounded-full hover:bg-gray-100 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
            </a>
            
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border border-gray-200">
                    <img src="<?= BASE_URL ?>uploads/profile/<?= $partner['photo'] ?? 'default.png' ?>" class="w-full h-full object-cover" onerror="this.src='https://placehold.co/100'">
                </div>
                <div>
    ...
    <div class="bg-white p-4 border-t border-gray-200">
        <form id="chat-form" class="max-w-4xl mx-auto flex gap-3 items-center">
            ...
            <button type="submit" class="bg-[#1E3A8A] text-white p-3 rounded-full hover:bg-blue-900 transition shadow-lg hover:shadow-xl transform active:scale-95">
