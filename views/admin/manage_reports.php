            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <table class="w-full text-left">
                    ...
                    <tbody class="text-gray-700">
                                        ...
                                        <?php if ($row['status'] == 'reported'): ?>
                                            <form action="<?= BASE_URL ?>actions/admin_reports.php" method="POST">
                                                ...
                                                <button type="submit" name="status" value="accepted"
                                                    class="bg-green-600 text-white px-3 py-1 rounded text-xs hover:bg-green-700 mr-1">Terima</button>
                                                <button type="submit" name="status" value="rejected"
                                                    class="bg-red-600 text-white px-3 py-1 rounded text-xs hover:bg-red-700">Tolak</button>
                                            </form>
                                        <?php else: ?>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="p-6 text-center text-gray-500">Tidak ada laporan baru.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
