...
<body class="bg-[#F8FAFC] font-[Inter] text-slate-800 overflow-x-hidden">
    ...
    <aside id="sidebar" 
           class="fixed top-16 left-0 z-40 h-[calc(100vh-4rem)] bg-[#1E3A8A] text-white 
        ...
        <div id="menu-wrapper" class="flex flex-col gap-2 px-3 w-full mt-6">
            ...
            <a href="<?= BASE_URL ?>index.php" 
               class="menu-item flex flex-row items-center gap-4 px-3 py-3 rounded-xl hover:bg-[#059669]/50 transition-all group w-full 
               ...
               <span class="sidebar-text font-semibold text-sm whitespace-nowrap overflow-hidden transition-all duration-300">
                   Beranda
               </span>
            </a>
            ...
            <?php if (isset($_SESSION['username'])): ?>
                ...
                <a href="<?= BASE_URL ?>views/user/chat_list.php" 
                   ...
                   <span class="sidebar-text text-sm font-semibold whitespace-nowrap overflow-hidden transition-all duration-300">
                       Pesan
                   </span>
    ...
    <div id="main-content" class="pt-20 px-6 min-h-screen w-full md:pl-64 transition-all duration-300 ease-in-out flex flex-col">