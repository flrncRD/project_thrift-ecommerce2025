...
<div class="container mx-auto px-6 py-10 flex justify-center">
    <div class="w-full max-w-2xl bg-white p-8 rounded-lg shadow-lg border-t-4 border-[#FACC15]">
        <h2 class="text-2xl font-bold text-[#1E3A8A] mb-6">Jual Barang Bekas</h2>

        <form action="<?= BASE_URL ?>actions/product_create.php" method="POST" enctype="multipart/form-data">
