            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:pl-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_buyer" class="w-full border p-3 rounded-xl mt-1"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kota_buyer" class="w-full border p-3 rounded-xl mt-1"
                            placeholder="Kota tujuan" required pattern="[A-Za-z\s]+">
                    </div>

                    <div class="mb-4">
                        <label class="text-sm font-semibold">No. HP</label>
                        <input type="text" name="phone_buyer" class="w-full border p-3 rounded-xl mt-1"
                            placeholder="089xxxxxxx" required pattern="[0-9]{10,15}">
                    </div>
                    ...
                    <input type="submit"
                        class="w-full py-3 bg-[#059669] hover:bg-[#047857] text-white font-bold rounded-xl"
                        value="Checkout">
                    </input>
                    </form>
                </div>
